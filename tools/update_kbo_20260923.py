#!/usr/bin/env python3
"""Collect and reconcile the 2026-09-23 KBO final slate."""
...
DATE, COMPACT = "2026-09-23", "20260923"
...
for rel in ("kbo/index.html", "kbo-players/index.html"):
    ...
    text = re.sub(r"2026\.09\.\d{2}", "2026.09.23", text)
    text = re.sub(r"2026년 9월 \d{1,2}일", "2026년 9월 23일", text)
